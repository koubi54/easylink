 ...
 */ !(function (t) {
  ...
  function (t, e, n) {
    ...
    (e.g = function () {
        ...
        switch (n.actionTypeId) {
          ...
          case h.i:
            var c = r.getStyle,
              ...
              m = v.widthValue,
              b = v.heightValue;
            if (!y.c) return { widthValue: m, heightValue: b };
            if (d === g.a) {
              var w = c(e, g.O);
              s(e, g.O, ""), (m = f(e, "offsetWidth")), s(e, g.O, w);
            }
            if (p === g.a) {
              var x = c(e, g.v);
              s(e, g.v, ""), (b = f(e, "offsetHeight")), s(e, g.v, x);
            }
            return { widthValue: m, heightValue: b };
          case h.e:
          case h.f:
          case h.j:
            var _ = n.config,
              ...
              switch (u) {
                case h.i:
                  var s = r.config,
                    ...
                    y = n.heightValue;
                  void 0 !== m &&
                    (d === g.a && (d = "px"), U(t, g.O, o), a(t, g.O, m + d)),
                    void 0 !== y &&
                      (v === g.a && (v = "px"), U(t, g.v, o), a(t, g.v, y + v));
                  break;
                case h.g:
                  !(function (t, e, n, r) {
                    var i = l()(
      ...
      (e.a = function (t, e, n) {
        ...
        i(t, g.P) && X({ effect: q, actionTypeId: o, elementApi: n })(t);
      }),
      (e.j = H),
      (e.o = function (t) {
      ...
      (e.s = function (t, e) {
        var n = e.basedOn;
        return (
          (t === m.w && (n === m.g || null == n)) || (t === m.j && n === m.g)
        );
      }),
      (e.k = function (t, e) {
        return t + g.h + e;
    ...
    var x = function (t) {
      ...
      _ = Object.freeze(
        (w((r = {}), h.e, g.c), w(r, h.f, g.e), w(r, h.j, g.i), r)
      ),
      O = Object.freeze(
        (w((i = {}), y.d, g.L),
        w(i, g.c, g.b),
    ...
    function A(t) {
      ...
      if (
        (k
          ? ((M = A.limitAffectedElements), (C = P), (L = c(A)))
          : (C = L = c({ id: w, selector: _, selectorGuids: O })),
        n && E)
      ) {
        var D = r && (L || !0 === E) ? [r] : s(P);
        if (L) {
    ...
    function G(t) {
      ...
      e.actionItems.forEach(function (t) {
        var e = t.actionTypeId,
          i = t.config,
          o = X({ effect: B, actionTypeId: e, elementApi: r });
      ...
      var P = (e.frame = (function () {
        ...
        N = f(function (e) {
          ...
          (e.init = function (e) {
            ...
            M.backface &&
              X.hideBackface &&
              B(this.el, M.backface.css, "hidden");
          }),
            b("add", i),
            b("start", o),
            b("wait", function (t) {
  ...
  function (t, e, n) {
    ...
    function N(t, e) {
      ...
      if (
        ...
        H({ store: e, actionListId: r }),
          B({ store: e, actionListId: r, eventId: o });
        var l = $({
          store: e,
          eventId: o,
          actionListId: r,
        ...
        s &&
          l &&
          e.dispatch(
            Object(j.actionListPlaybackChanged)({
              actionListId: r,
              isPlaying: !u,
            })
          );
                      ...
                      if (c()(l)) {
                        m()(l, function (t, e) {
                          ...
                          (u.actionTypeId === T.c || D(u.actionTypeId)) &&
                            B({ store: n, actionListId: s, eventId: c });
                        });
                        var d = function (t) {
                            var e = n.getState(),
                              i = e.ixSession;
                            G(l, function (e, o, a) {
                              ...
                              if (Object(O.r)(p, i.mediaQueryKey)) {
                                var v = function () {
                                  ...
                                  _()(i, f) ||
                                    n.dispatch(
                                      Object(j.eventStateChanged)(a, i)
                                    );
                                };
                            ...
                            i.split(" ")
                              ...
                              .forEach(function (t) {
                                ...
                                r.addEventListener(t, e),
                                  n.dispatch(
                                    Object(j.eventListenerAdded)(r, [t, e])
                                  );
                              });
                          };
                        Array.isArray(o)
                  ...
                  (function (t) {
                    ...
                    q.forEach(function (n) {
                      window.addEventListener(n, e),
                        t.dispatch(
                          Object(j.eventListenerAdded)(window, [n, e])
                        );
                    }),
                      e();
                  })(t);
          ...
          (function (t) {
            !(function e(n) {
              var r = t.getState(),
                ...
                o = r.ixParameters;
              i.active &&
                (t.dispatch(Object(j.animationFrameChanged)(n, o)),
    ...
    function F(t) {
      ...
      e.active &&
        (e.eventListeners.forEach(U), t.dispatch(Object(j.sessionStopped)()));
    }
    function U(t) {
      var e = t.target,
        n = t.listenerParams;
    ...
    function $(t) {
      ...
      if (!Object(O.r)(m, p.mediaQueryKey)) return !1;
      ...
      e.dispatch(
        ...
        u
          ? (function (t, e) {
              ...
              t.dispatch(
                Object(j.animationFrameChanged)(Number.POSITIVE_INFINITY, n)
              ),
            ...
            i.fileUploads.each(function (e) {
              !(function (e, n) {
                ...
                var r,
                  ...
                  m = v.find(".w-file-upload-file-name"),
      ...
      f = function () {
        ...
        switch (e.type) {
          ...
          case i.h:
            ...
            if (!t[M]) return t;
            for (
              var C = {}, L = Object.keys(t), P = L.length, D = 0;
              D < P;
              D++
            ) {
              var N = L[D];
  ...
  function (t, e, n) {
    ...
    t.exports = function (t, e, n, m, g, y) {
      ...
      return !!j && (y || (y = new r()), a(t, e, n, m, g, y));
    };
  },
  function (t, e, n) {
    var r = n(27),
  ...
  function (t, e, n) {
    ...
    var y,
      ...
      x = function (t) {
        return function (e) {
          return (
            !("object" !== (void 0 === e ? "undefined" : m(e)) || !t(e)) || e
          );
        };
      },
      _ = x(function (t) {
      ...
      g(r, p.j, {
        ...
        handler: function (t) {
          ...
          return (
            ...
            { elementHovered: A, clientX: g, clientY: b, pageX: x, pageY: O }
          );
        },
      }),
      g(r, p.s, {
      ...
      g(r, p.w, {
        ...
        handler: function (t) {
          ...
          if (h === p.D) {
            ...
            return (
              S !== o.scrollPercent &&
                n.dispatch(Object(d.parameterChanged)(g, S)),
              { scrollPercent: S }
            );
          }
          ...
          return (
            N !== o.scrollPercent &&
              n.dispatch(Object(d.parameterChanged)(T, N)),
            { scrollPercent: N }
          );
        },
      }),
    ...
    t.exports = function (t) {
      return i(function (e) {
        ...
        for (t && e.reverse(); i--; ) {
          ...
          if (v && !m && "wrapper" == a(h)) var m = new r([], !0);
        }
        for (i = m ? i : n; ++i < n; ) {
          h = e[i];
          var g = a(h),
        ...
        return function () {
          var t = arguments,
            r = t[0];
          if (m && 1 == t.length && u(r)) return m.plant(r).value();
  ...
  function (t, e, n) {
    ...
    r.define(
      ...
      (t.exports = function (t, e) {
        ...
        function h() {
          (n = f.find(d)).length &&
            (n.filter(":visible").each(y),
            (u = null),
            a || (m(), r.resize.on(g), r.redraw.on(c.redraw)));
        }
        function m() {
        ...
        function y(e, n) {
          ...
          i.el.off(d),
            ...
            b(i),
            o
              ? (i.el.on("setting" + d, I(i)), O(i), (i.hasTimer = !1))
              : (i.el.on("swipe" + d, I(i)),
                i.left.on("tap" + d, x(i)),
        ...
        function j(e, n) {
          ...
          if (e.index !== e.previous) {
            if ("cross" === y) {
              ...
              return (
                (_ = "opacity " + I + "ms " + b),
                s(m).set({ visibility: "" }).add(_).start({ opacity: 0 }),
                void s(h)
          ...
          actionItems: [
            {
              ...
              config: {
                ...
                target: {
                  useEventTarget: true,
                  id:
                    "5af49de0dbb1e358142d8887|cafe0045-d304-79d9-8f68-af3adaed06e9",
                },
                yValue: 40,
                xUnit: "PX",
                yUnit: "PX",
          ...
          actionItems: [
            {
              ...
              config: {
                ...
                target: {
                  id:
                    "5af49de0dbb1e358142d8887|77e69727-c455-8e07-0990-833a661c94ea",
                },
                yValue: 60,
                xUnit: "PX",
                yUnit: "PX",
            ...
            },
            {
              ...
              config: {
                ...
                target: {
                  id:
                    "5af49de0dbb1e358142d8887|6b220cb1-4b9c-7fb0-75b9-53ff4a6c35a2",
                },
                yValue: 30,
                xUnit: "PX",
                yUnit: "PX",
