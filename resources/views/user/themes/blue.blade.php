...
<div id="container" class="">
    ...
    <div class="row">
        <div class="d-flex align-items-center mt-1 mx-auto"
            style="min-width: 80px; border: 1px solid lightgrey; background: rgba(255, 255, 255, 0.1); border:none; border-radius: 50px;">
            ...
            <span class="copyText mx-3 text-light" style="overflow: hidden;">{{ route('public', $user->username) }}</span>
        </div>
    </div>
    @endauth
    ...
    " src="{{ asset($user->photo) }}" alt="">
            ...
            <div class="col-md-7 d-flex align-items-center">
                <div class="mx-auto">
                    <h3 class="text-light text-center bios-fullname">{{ $user->fullname }}</h3>
                    @if ($user->location)
    ...
    <div class="link-buttons mx-auto mt-5 p-3">
        ...
        <div class="row mt-4">
            ...
            <a href="{{ $link->brand == 'mail' ? 'mailto:' : '' }}{{ $link->link }}" data-id="{{ $link->id }}" onclick="track(this)" id="li-{{ $loop->iteration }}"
                style="border-radius: 13px; padding: 0; background: hsla(0,0%,100%,.2);"
                class="btn d-flex align-items-center mt-3 btn-block btn-lg">
                <span style="border-right: 1px solid rgba(0,0,0,0.1); padding: 16px;"
