<link rel="stylesheet" href="{{ asset('css/themes/sunset.css') }}">
...
<div id="container" class="">
    ...
    <div class="row">
        <div class="d-flex align-items-center mt-1 mx-auto"
            ...
            <span style="overflow: hidden;" class="copyText text-light mx-3">{{ route('public', $user->username) }}</span>
    ...
    <div class="link-buttons mx-auto mt-5 p-3">
        ...
        <div class="row mt-4">
            ...
            <a href="{{ $link->brand == 'mail' ? 'mailto:' : '' }}{{ $link->link }}" data-id="{{ $link->id }}"
                ...
                style="border-radius: 13px; padding: 0; background: rgba(0,0,0,.3);"
