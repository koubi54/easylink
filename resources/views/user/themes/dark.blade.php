...
<div id="container" class="">
    ...
    <div class="row">
            ...
            <span class="copyText text-light mx-3"
                style="overflow: hidden;">{{ route('public', $user->username) }}</span>
        </div>
    </div>
    @endauth
        ...
        " src="{{ asset($user->photo) }}" alt="">
            ...
            <div class="col-md-7 d-flex align-items-center">
                <div class="mx-auto">
                    ...
                    @endif
                    <h6 class="py-4 text-center text-light text-muted">{{ $user->bio }}</h6>
                </div>
            </div>
        </div>
    </div>
    <div class="link-buttons mx-auto mt-5 p-3">
        <div class="row mt-4">
            ...
            <a href="{{ $link->brand == 'mail' ? 'mailto:' : '' }}{{ $link->link }}" data-id="{{ $link->id }}"
                onclick="track(this)" id="li-{{ $loop->iteration }}" style="border-radius: 13px; padding: 0;"
