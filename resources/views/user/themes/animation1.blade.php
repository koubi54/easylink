<link rel="stylesheet" href="{{ asset('css/themes/animation1.css') }}">
    ...
    " src="{{ asset($user->photo) }}" alt="">
            ...
            <div class="col-md-7 d-flex align-items-center">
                <div class="mx-auto">
                    ...
                    <h6 class="py-4 text-center text-muted text-light">{{ $user->bio }}</h6>
                </div>
            </div>
        </div>
    </div>
    <div class="link-buttons mx-auto mt-5 p-3">
        ...
        <div class="row mt-4">
            ...
            <a href="{{ $link->brand == 'mail' ? 'mailto:' : '' }}{{ $link->link }}" data-id="{{ $link->id }}"
                ...
                style="border-radius: 13px; padding: 0; background: rgba(0,0,0,.25);"
