<link rel="stylesheet" href="{{ asset('css/themes/purple.css') }}">
...
<div id="container" class="">
    ...
    <div class="row">
        <div class="d-flex align-items-center mt-1 mx-auto"
            ...
            <span style="overflow:hidden;" class="copyText mx-3 text-light">{{ route('public', $user->username) }}</span>
        </div>
    </div>
    @endauth
    ...
    <div class="link-buttons mx-auto mt-5 p-3">
        <div class="row mt-4">
            ...
            <a href="{{ $link->brand == 'mail' ? 'mailto:' : '' }}{{ $link->link }}" data-id="{{ $link->id }}"
                ...
                style="border-radius: 13px; padding: 0; border: 1px solid #fff;"
                class="btn d-flex align-items-center mt-3 btn-block btn-lg">
                <span style="border-right: 1px solid #fff; padding: 16px;"
